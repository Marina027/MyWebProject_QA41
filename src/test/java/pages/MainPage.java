...
public class MainPage extends BasePage{
     ...
     */
    public static <T extends BasePage> T openTopMenu(String topMenuItem){ //  <T extends BasePage>: Это обобщённый тип данных.
        ...
        // Здесь driver передается в качестве аргумента конструктору класса HomePage. пример использования обобщенного
            // программирования в Java // (T): Это оператор приведения типа (type casting). В данном случае (T) означает,
